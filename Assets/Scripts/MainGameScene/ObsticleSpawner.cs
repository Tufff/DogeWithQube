...
public class ObsticleSpawner : MonoBehaviour
{
    ...
    public void SpawnRowOfObsticles(GameObject obsticle, int minObsticles = 0, float positionZ = 40f)
    {
        ...
        int howManyInRow = Random.Range(minObsticles, numberOfObsticles);
        ...
        for (int i = 0; i < howManyInRow; i++)
        {
            ...
            Instantiate(obsticle, new Vector3(leftSideX, -0.5f, positionZ), Quaternion.identity, triggerTransform);
