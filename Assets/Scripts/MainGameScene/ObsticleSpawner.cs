...
public class ObsticleSpawner : MonoBehaviour
{
    ...
    [SerializeField]
    protected GameObject spawnTriggerObject;
    [SerializeField]
    ...
    public void SpawnRowOfObsticles(GameObject[] obsticle, int minObsticles = 0, float positionZ = 40f, float positionY = -0.5f)
    {
        ...
        int randomObsticleId = Random.Range(0, obsticle.Length);
        ...
        for (int i = 0; i < howManyInRow; i++)
        {
            ...
            Instantiate(obsticle[randomObsticleId], new Vector3(leftSideX, positionY, positionZ), Quaternion.Euler(-90f, 0f, 0f), triggerTransform);
